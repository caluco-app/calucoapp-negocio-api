...
--
-- Host: localhost    Database: calucoappdb
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `after_insert_ticketitems` AFTER INSERT ON `ticketitems` FOR EACH ROW BEGIN
...
-- Dump completed on 2024-03-31 12:13:02
